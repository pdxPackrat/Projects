...
{
    public class AcspSetRplLocationResponse
    {
        private AcspRequestId _requestId;
        private AcspStatusResponse _statusResponse;

        public AcspSetRplLocationResponse(Byte[] inputArray)
        {
        ...
        private void InitializeData(byte[] inputArray)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("Error: was expecting at least a 9-byte array for SetRplLocationResponse constructor");
            }

            // Take a 4-byte slice and convert UInt32 for RequestId
            int i = 0;  // index for inputArray
