...
{
    public class AcspGetStatusResponse
    {
        private AcspRequestId _requestId;
        private AcspStatusResponse _statusResponse;

        public AcspGetStatusResponse(Byte[] inputArray)
        {
        ...
        private void InitializeData(byte[] inputArray)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("Error: was expecting at least a 9-byte array for GetStatusResponse constructor");
            }
